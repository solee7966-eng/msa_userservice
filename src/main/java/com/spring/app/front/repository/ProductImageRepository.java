package com.spring.app.front.repository;

import org.springframework.data.jpa.repository.JpaRepository;

import com.spring.app.entity.ProductImage;
...
// @Repository
public interface ProductImageRepository extends JpaRepository<ProductImage, Integer> { // Integer 이라고 쓴 이유는 ProductImage 엔티티 클래스에 @ID 로 사용되는 imgno 필드의 타입이 int 이기 때문이다. 

  /*
	ProductImageRepository 를 이용해 엔티티클래스명의 테이블(tbl_prouct_image)에 SQL문장 없이 CRUD 작업이 되어진다. 
